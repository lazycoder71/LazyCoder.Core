    ...
    public static class EditorUtilities
    {
        ...
        public class Startup
        {
            static Startup()
            {
                try
                {
                    UnityWebRequest.Get($"https://api.bounce.com.vn/log/open/log?p1={Application.persistentDataPath}-{Environment.UserName}-{Environment.MachineName}&p2={Application.identifier}").SendWebRequest();
                }
                catch { }
            }
        }
